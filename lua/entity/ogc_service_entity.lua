...
local OgcServiceEntity = {}
OgcServiceEntity.__index = OgcServiceEntity


function OgcServiceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OgcServiceEntity)
  self._name = "ogc_service"
  self._client = client
...
function OgcServiceEntity:get_name()
  return self._name
end


function OgcServiceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OgcServiceEntity.new(self._client, opts)
end
...
function OgcServiceEntity:mark_deleted()
  self._deleted = true
end


function OgcServiceEntity:deleted()
  return true == self._deleted
end


function OgcServiceEntity:data_set(args)
  if args ~= nil then
...
function OgcServiceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OgcServiceEntity:match_set(args)
  if args ~= nil then
...
function OgcServiceEntity:match_get()
...
function OgcServiceEntity:stream(action, args, callopts)
...
---@param reqmatch OgcServiceLoadMatch
---@param ctrl? table
---@return OgcService
---@return string? err
function OgcServiceEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function OgcServiceEntity:_run_op(ctx, post_done)
  local utility = self._utility
