...
The Lua SDK for the HongKongCsdi API — an entity-oriented client using Lua conventions.
...
```lua
local ogc_service, err = client:OgcService():load({ request = "request", service = "service", version = "version" })
```
