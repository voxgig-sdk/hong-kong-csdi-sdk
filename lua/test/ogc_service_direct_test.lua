...
describe("OgcServiceDirect", function()
  it("should direct-load-ogc_service", function()
    local setup = ogc_service_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ogc_service", setup.live and "live" or "unit")
...
function ogc_service_direct_setup(mockres)
