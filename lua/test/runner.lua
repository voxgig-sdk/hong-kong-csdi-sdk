...
function runner.env_override(m)
  local live = runner.getenv("HONGKONGCSDI_TEST_LIVE")
  local override = runner.getenv("HONGKONGCSDI_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("HONGKONGCSDI_TEST_EXPLAIN")
