...
function runner.env_override(m)
  local live = runner.getenv("HONG_KONG_CSDI_TEST_LIVE")
  local override = runner.getenv("HONG_KONG_CSDI_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("HONG_KONG_CSDI_TEST_EXPLAIN")
