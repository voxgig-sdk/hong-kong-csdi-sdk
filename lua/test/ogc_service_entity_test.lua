...
describe("OgcServiceEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set HONG_KONG_CSDI_TEST_OGC_SERVICE_ENTID JSON to run live")
      return
    end
...
function ogc_service_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("HONG_KONG_CSDI_TEST_OGC_SERVICE_ENTID")
  ...
  local idmap_resolved = helpers.to_map(
    env["HONG_KONG_CSDI_TEST_OGC_SERVICE_ENTID"])
