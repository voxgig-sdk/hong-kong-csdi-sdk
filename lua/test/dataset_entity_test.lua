...
describe("DatasetEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set HONGKONGCSDI_TEST_DATASET_ENTID JSON to run live")
      return
    end
...
function dataset_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("HONGKONGCSDI_TEST_DATASET_ENTID")
