...
(0, node_test_1.describe)('OgcServiceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.HongKongCsdiSDK({
    ...
    (0, node_test_1.test)('direct-load-ogc_service', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ogc_service', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.HONG_KONG_CSDI_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.HongKongCsdiSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.HONG_KONG_CSDI_APIKEY,
        }));
        let idmap = env['HONG_KONG_CSDI_TEST_OGC_SERVICE_ENTID'];
    ...
    const client = new __1.HongKongCsdiSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=OgcServiceDirect.test.js.map