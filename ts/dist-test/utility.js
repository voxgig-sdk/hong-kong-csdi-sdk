...
function envOverride(m) {
    if ('TRUE' === process.env.HONG_KONG_CSDI_TEST_LIVE ||
        'TRUE' === process.env.HONG_KONG_CSDI_TEST_OVERRIDE) {
    ...
    m.HONG_KONG_CSDI_TEST_EXPLAIN = process.env.HONG_KONG_CSDI_TEST_EXPLAIN || m.HONG_KONG_CSDI_TEST_EXPLAIN;
    return m;
}
