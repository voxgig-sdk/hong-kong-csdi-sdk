...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.HONGKONGCSDI_TEST_LIVE ||
    'TRUE' === process.env.HONGKONGCSDI_TEST_OVERRIDE
  ) {
  ...
  m.HONGKONGCSDI_TEST_EXPLAIN = process.env.HONGKONGCSDI_TEST_EXPLAIN || m.HONGKONGCSDI_TEST_EXPLAIN
