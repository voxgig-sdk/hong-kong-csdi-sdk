...
type Args struct {
	Entity string         `json:"entity" jsonschema:"dataset | ogc_service"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.HongKongCsdiSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "hong-kong-csdi_list",
		Description: "List records from HongKongCsdi. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "hong-kong-csdi_load",
		Description: "Load a single record from HongKongCsdi. " +
...
func runOp(client *sdk.HongKongCsdiSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.HongKongCsdiSDK, name string) (sdk.HongKongCsdiEntity, error) {
	switch strings.ToLower(name) {
	case "dataset":
		return client.Dataset(nil), nil
	case "ogc_service":
		return client.OgcService(nil), nil
