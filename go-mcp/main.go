// Command HongKongCsdi-mcp is an MCP server exposing the HongKongCsdi
// SDK as MCP tools.
//
// Two tools are registered:
//
//	HongKongCsdi_list  — list records of an entity
//	HongKongCsdi_load  — load a single record of an entity
//
