...
from hongkongcsdi_sdk.utility import register

# Load features
from hongkongcsdi_sdk.feature.base_feature import HongKongCsdiBaseFeature
from hongkongcsdi_sdk.features import _has_feature, _make_feature
...
class HongKongCsdiSDK:
    ...
    def get_utility(self):
        return HongKongCsdiUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("HongKongCsdiSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Dataset(self, data=None) -> "DatasetEntity":
        ...
        from hongkongcsdi_sdk.entity.dataset_entity import DatasetEntity
    ...
    def OgcService(self, data=None) -> "OgcServiceEntity":
        ...
        from hongkongcsdi_sdk.entity.ogc_service_entity import OgcServiceEntity
