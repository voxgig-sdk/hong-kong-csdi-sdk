# HongKongCsdi SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HongKongCsdiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HongKongCsdiSDK(...) and HongKongCsdiSDK.test(...) become
#      HongKongCsdiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "hongkongcsdi_sdk"
_SDK_CLASS = "HongKongCsdiSDK"
