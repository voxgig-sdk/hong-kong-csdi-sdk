...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/hong-kong-csdi` | `npm install @voxgig-sdk/hong-kong-csdi` |
| Python | `voxgig-sdk-hong-kong-csdi` | `pip install voxgig-sdk-hong-kong-csdi` |
| PHP | `voxgig-sdk/hong-kong-csdi` | `composer require voxgig-sdk/hong-kong-csdi` |
| Golang | `github.com/voxgig-sdk/hong-kong-csdi-sdk/go` | `go get github.com/voxgig-sdk/hong-kong-csdi-sdk/go` |
| Ruby | `voxgig-sdk-hong-kong-csdi` | `gem install voxgig-sdk-hong-kong-csdi` |
| Lua | `voxgig-sdk-hong-kong-csdi` | `luarocks install voxgig-sdk-hong-kong-csdi` |
