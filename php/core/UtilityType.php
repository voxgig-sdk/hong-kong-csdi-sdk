...
// HongKongCsdi SDK utility type

class HongKongCsdiUtility
{
    ...
    public static function copy(HongKongCsdiUtility $src): HongKongCsdiUtility
    {
        $u = new HongKongCsdiUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
