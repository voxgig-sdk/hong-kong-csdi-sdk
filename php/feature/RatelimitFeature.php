...
// HongKongCsdi SDK ratelimit feature
...
class HongKongCsdiRatelimitFeature extends HongKongCsdiBaseFeature
{
    ...
    private function _acquire(HongKongCsdiContext $ctx): void
    {
    ...
    private function _track(HongKongCsdiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
