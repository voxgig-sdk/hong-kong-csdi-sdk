...
// HongKongCsdi SDK clienttrack feature
...
class HongKongCsdiClienttrackFeature extends HongKongCsdiBaseFeature
{
    ...
    public function PostConstruct(HongKongCsdiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'HongKongCsdi-SDK';
