...
// HongKongCsdi SDK timeout feature
...
class HongKongCsdiTimeoutFeature extends HongKongCsdiBaseFeature
{
    ...
    private function _with_timeout(HongKongCsdiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HongKongCsdiContext $_ctx, float $ms): void
    {
        $client = $this->client;
