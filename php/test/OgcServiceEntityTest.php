...
class OgcServiceEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set HONG_KONG_CSDI_TEST_OGC_SERVICE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function ogc_service_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("HONG_KONG_CSDI_TEST_OGC_SERVICE_ENTID");
