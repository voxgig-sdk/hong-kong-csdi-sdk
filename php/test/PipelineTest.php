...
// HongKongCsdi SDK pipeline test
//
...
{
    private static function utility(): HongKongCsdiUtility
    {
        return new HongKongCsdiUtility();
    }
    ...
    private static function ctx(array $over = []): HongKongCsdiContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new HongKongCsdiContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new HongKongCsdiOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof HongKongCsdiError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new HongKongCsdiOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = HongKongCsdiMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new HongKongCsdiOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = HongKongCsdiMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new HongKongCsdiOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = HongKongCsdiMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HongKongCsdiSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = HongKongCsdiMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new HongKongCsdiResponse([]),
            'result' => new HongKongCsdiResult([]),
        ]);
        [, $err] = HongKongCsdiMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new HongKongCsdiSpec([]),
            'response' => null,
            'result' => new HongKongCsdiResult([]),
        ]);
        [, $err] = HongKongCsdiMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new HongKongCsdiSpec(['step' => 's']),
            'response' => new HongKongCsdiResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new HongKongCsdiResult([]),
        ]);
        [, $err] = HongKongCsdiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new HongKongCsdiSpec(['step' => 's']),
            'response' => new HongKongCsdiResponse(self::resp(200, ['v' => 1])),
            'result' => new HongKongCsdiResult([]),
        ]);
        [, $err] = HongKongCsdiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new HongKongCsdiSpec(['step' => 's']),
            'response' => new HongKongCsdiResponse(self::resp(200, ['v' => 2])),
            'result' => new HongKongCsdiResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        HongKongCsdiMakeResponse::call($ctx);
    ...
    {
        $preset = new HongKongCsdiResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new HongKongCsdiSpec([]),
            'response' => new HongKongCsdiResponse([]),
            'result' => new HongKongCsdiResult([]),
        ...
        [$got, $err] = HongKongCsdiMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new HongKongCsdiResult([])]);
        [, $err] = HongKongCsdiMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new HongKongCsdiSpec([]), 'result' => null]);
        [, $err] = HongKongCsdiMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HongKongCsdiSpec(['step' => 's']),
            'result' => new HongKongCsdiResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new HongKongCsdiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HongKongCsdiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HongKongCsdiSpec(['step' => 's']),
            'result' => new HongKongCsdiResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new HongKongCsdiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HongKongCsdiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HongKongCsdiResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new HongKongCsdiSpec([]),
            'result' => new HongKongCsdiResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = HongKongCsdiMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HongKongCsdiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new HongKongCsdiError('boom', 'boom');
        $utility->fetcher = function (HongKongCsdiContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HongKongCsdiSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = HongKongCsdiMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (HongKongCsdiContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = HongKongCsdiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(HongKongCsdiResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        HongKongCsdiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (HongKongCsdiContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HongKongCsdiSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = HongKongCsdiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new HongKongCsdiResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new HongKongCsdiSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = HongKongCsdiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = HongKongCsdiMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = HongKongCsdiMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new HongKongCsdiResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, HongKongCsdiDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new HongKongCsdiResult(['ok' => false])]);
        $this->expectException(HongKongCsdiError::class);
        HongKongCsdiDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new HongKongCsdiResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', HongKongCsdiMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        HongKongCsdiMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new HongKongCsdiBaseFeature();
        $b = new HongKongCsdiBaseFeature();
        HongKongCsdiFeatureAdd::call($ctx, $a);
        HongKongCsdiFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): HongKongCsdiBaseFeature
    {
        $f = new HongKongCsdiBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        HongKongCsdiFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): HongKongCsdiContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new HongKongCsdiSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HongKongCsdiPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        HongKongCsdiPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new HongKongCsdiResponse(['headers' => null]),
            'result' => new HongKongCsdiResult([]),
        ]);
        HongKongCsdiResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        HongKongCsdiResultBody::call($ctx);
