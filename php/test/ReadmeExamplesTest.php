...
// HongKongCsdi SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HongKongCsdiSDK::test)
...
{
    private const SDK_CLASS = 'HongKongCsdiSDK';
    ...
    private const SDK_BASE = 'hongkongcsdi_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../hongkongcsdi_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
