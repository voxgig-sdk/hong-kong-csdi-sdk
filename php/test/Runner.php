...
class HongKongCsdiTestRunner
{
    ...
    {
        $live = self::getenv('HONG_KONG_CSDI_TEST_LIVE');
        $override = self::getenv('HONG_KONG_CSDI_TEST_OVERRIDE');
        ...
        $explain = self::getenv('HONG_KONG_CSDI_TEST_EXPLAIN');
...
class_alias('HongKongCsdiTestRunner', 'Runner');
class_alias('HongKongCsdiHelpers', 'Helpers');
