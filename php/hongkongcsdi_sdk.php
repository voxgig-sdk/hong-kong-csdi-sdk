...
class HongKongCsdiSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = HongKongCsdiHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = HongKongCsdiHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!HongKongCsdiFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, HongKongCsdiFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return HongKongCsdiUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = HongKongCsdiHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = HongKongCsdiHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = HongKongCsdiHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new HongKongCsdiError($op . "_allow",
                "HongKongCsdiSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = HongKongCsdiHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new HongKongCsdiError("graphql_error",
                "HongKongCsdiSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function OgcService($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_ogc_service === null) {
                $this->_ogc_service = new OgcServiceEntity($this, null);
            }
            return $this->_ogc_service;
        }
        return new OgcServiceEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new HongKongCsdiSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
