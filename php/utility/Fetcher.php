...
// HongKongCsdi SDK utility: fetcher

class HongKongCsdiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HongKongCsdiSDK/1.0)';
    ...
    public static function call(HongKongCsdiContext $ctx, string $fullurl, array $fetchdef): array
    {
