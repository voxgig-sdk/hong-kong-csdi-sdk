...
// HongKongCsdi SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class HongKongCsdiTransformResponse
{
    public static function call(HongKongCsdiContext $ctx): mixed
    {
        ...
        $transform = HongKongCsdiHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
