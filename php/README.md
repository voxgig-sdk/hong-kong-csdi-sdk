# HongKongCsdi PHP SDK



The PHP SDK for the HongKongCsdi API — an entity-oriented client using PHP conventions.
...
print_r(array_map(fn($item) => $item->data_get(), $dataset));
```
...
```
php/
├── hongkongcsdi_sdk.php          -- Main SDK class
...
The main class (`hongkongcsdi_sdk.php`) exports the SDK class
