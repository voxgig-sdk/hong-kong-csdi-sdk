...
require_relative 'HongKongCsdi_types'
...
class HongKongCsdiSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = HongKongCsdiHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = HongKongCsdiHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, HongKongCsdiFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    HongKongCsdiUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = HongKongCsdiHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = HongKongCsdiHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = HongKongCsdiHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def raw_request(fetchargs = {})
    ...
    if fetched.is_a?(Hash)
      status = HongKongCsdiHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = HongKongCsdiError.new(
        "graphql_error", "HongKongCsdiSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = HongKongCsdiSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
