...
class DatasetEntity
  ...
  # @return [Dataset, Hash] the loaded Dataset; raises HongKongCsdiError on failure
  ...
  #
  # @param reqmatch [DatasetListMatch, Hash, nil] match filter (any subset of
  #   Dataset fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Dataset>, Array] the matching Dataset items; raises HongKongCsdiError on failure
