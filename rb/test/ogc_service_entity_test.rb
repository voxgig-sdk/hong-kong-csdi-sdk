...
class OgcServiceEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set HONG_KONG_CSDI_TEST_OGC_SERVICE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def ogc_service_basic_setup(extra)
  ...
  entid_env_raw = ENV["HONG_KONG_CSDI_TEST_OGC_SERVICE_ENTID"]
