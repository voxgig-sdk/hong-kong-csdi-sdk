...
#      offline in seeded test mode (HongKongCsdiSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "HongKongCsdi_sdk.rb")
  SDK_CLASS = "HongKongCsdiSDK"
