...
func (sdk *HongKongCsdiSDK) OptionsMap() map[string]any {
...
func (sdk *HongKongCsdiSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *HongKongCsdiSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *HongKongCsdiSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *HongKongCsdiSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *HongKongCsdiSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *HongKongCsdiSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("HongKongCsdiSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *HongKongCsdiSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *HongKongCsdiSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("HongKongCsdiSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *HongKongCsdiSDK {
	if sdkopts == nil {
	...
	sdk := NewHongKongCsdiSDK(sdkopts)
	sdk.Mode = "test"
