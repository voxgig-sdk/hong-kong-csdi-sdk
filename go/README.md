...
## Install
```bash
go get github.com/voxgig-sdk/hong-kong-csdi-sdk/go@latest
```

The Go module proxy resolves the version from the `go/vX.Y.Z` GitHub
release tag — see [Releases](https://github.com/voxgig-sdk/hong-kong-csdi-sdk/releases) for the available versions.
...
```bash
go mod edit -replace github.com/voxgig-sdk/hong-kong-csdi-sdk/go=../hong-kong-csdi-sdk/go
```
...
All entities implement the `HongKongCsdiEntity` interface.
...
| `apiEndpoints` | `map[string]any` | Available API endpoints for this dataset |
| `apiServiceCalls` | `float64` | Total API service calls in the specified year |
| `category` | `string` | Category of the dataset |
| `datasetDownloads` | `float64` | Total dataset downloads in the specified year |
...
| `spatialExtent` | `map[string]any` | Spatial extent of the dataset |
