...
// instead of `sdk.NewHongKongCsdiSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *HongKongCsdiSDK  { return NewHongKongCsdiSDK(nil) }
func Test() *HongKongCsdiSDK { return TestSDK(nil, nil) }
