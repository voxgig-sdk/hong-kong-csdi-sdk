...
const testSeed = `map[string]any{"entity": map[string]any{"dataset": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ogc_service": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
