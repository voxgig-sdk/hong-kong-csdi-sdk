...
type OgcServiceEntity struct {
	name    string
	client  *core.HongKongCsdiSDK
...
func NewOgcServiceEntity(client *core.HongKongCsdiSDK, entopts map[string]any) *OgcServiceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OgcServiceEntity) GetName() string { return e.name }
...
func (e *OgcServiceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OgcServiceEntity) Deleted() bool {
	return e.deleted
}


func (e *OgcServiceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOgcServiceEntity(e.client, opts)
}

func (e *OgcServiceEntity) Data(args ...any) any {
...
func (e *OgcServiceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an OgcService; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OgcServiceEntity) DataTyped(data ...OgcService) OgcService {
	if len(data) > 0 {
		return typedFrom[OgcService](e.Data(asMap(data[0])))
	}
	return typedFrom[OgcService](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through OgcService (all fields
// optional at the wire level).
func (e *OgcServiceEntity) MatchTyped(match ...OgcService) OgcService {
	if len(match) > 0 {
		return typedFrom[OgcService](e.Match(asMap(match[0])))
	}
	return typedFrom[OgcService](e.Match())
}
...
func (e *OgcServiceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OgcServiceEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OgcServiceLoadMatch and returns an OgcService. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *OgcServiceEntity) LoadTyped(reqmatch OgcServiceLoadMatch, ctrl map[string]any) (OgcService, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return OgcService{}, err
	}
	return typedFrom[OgcService](res), nil
}



func (e *OgcServiceEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *OgcServiceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OgcServiceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OgcServiceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OgcServiceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
