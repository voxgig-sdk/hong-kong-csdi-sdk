...
func registerSDKWords(r *eng.Registry, client *sdk.HongKongCsdiSDK) {
...
func runOp(client *sdk.HongKongCsdiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
