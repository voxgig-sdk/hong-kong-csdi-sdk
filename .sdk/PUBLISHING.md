...
|---|---|---|
| `ts/` | @voxgig-sdk/hong-kong-csdi-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/hong-kong-csdi-sdk \
      --repository voxgig-sdk/hong-kong-csdi-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/hong-kong-csdi-sdk` shows it, and
`npm trust revoke @voxgig-sdk/hong-kong-csdi-sdk --id=<id>` removes it.
