...
from projectname_sdk.core.control import HongKongCsdiControl
...
class HongKongCsdiContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, HongKongCsdiSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, HongKongCsdiResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, HongKongCsdiResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return HongKongCsdiError(code, msg, self)
