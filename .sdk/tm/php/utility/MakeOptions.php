...
// HongKongCsdi SDK utility: make_options

class HongKongCsdiMakeOptions
{
    ...
    public static function call(HongKongCsdiContext $ctx): array
    {
        ...
        //
        // `HongKongCsdiSchema::optspec()` is built from the model:
        ...
        $optspec = HongKongCsdiSchema::optspec();
