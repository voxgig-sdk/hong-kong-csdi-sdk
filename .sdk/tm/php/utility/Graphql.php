...
// HongKongCsdi SDK utility: graphql
//
...
class HongKongCsdiGraphql
{
    ...
    // equivalent.
    public static function body(HongKongCsdiContext $ctx): mixed
    {
    ...
    public static function errors(HongKongCsdiContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
