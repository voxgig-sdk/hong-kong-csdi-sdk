...
// HongKongCsdi SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class HongKongCsdiMakeRequest
{
    public static function call(HongKongCsdiContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new HongKongCsdiResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new HongKongCsdiResponse($fetched);
        } else {
