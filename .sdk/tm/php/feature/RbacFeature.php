...
class HongKongCsdiRbacFeature extends HongKongCsdiBaseFeature
{
    ...
    private function _required(HongKongCsdiContext $ctx): ?string
    {
    ...
    private function _reject(HongKongCsdiContext $ctx, string $required): void
    {
    ...
    private function _track(HongKongCsdiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
