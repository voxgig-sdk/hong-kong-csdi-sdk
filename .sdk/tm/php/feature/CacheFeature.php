...
// HongKongCsdi SDK cache feature
...
class HongKongCsdiCacheFeature extends HongKongCsdiBaseFeature
{
    ...
    private function _through(HongKongCsdiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
