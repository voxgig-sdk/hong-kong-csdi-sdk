...
// HongKongCsdi SDK proxy feature
...
class HongKongCsdiProxyFeature extends HongKongCsdiBaseFeature
{
    ...
    public function init(HongKongCsdiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (HongKongCsdiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
