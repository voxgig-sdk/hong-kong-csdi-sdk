...
// HongKongCsdi SDK netsim feature
...
class HongKongCsdiNetsimFeature extends HongKongCsdiBaseFeature
{
    ...
    private function _simulate(HongKongCsdiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(HongKongCsdiContext $ctx, array $applied): void
    {
        $client = $this->client;
