...
// HongKongCsdi SDK audit feature
...
class HongKongCsdiAuditFeature extends HongKongCsdiBaseFeature
{
    ...
    private function _emit(HongKongCsdiContext $ctx, string $outcome): void
    {
