...
// HongKongCsdi SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = HongKongCsdiOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(HongKongCsdiOmni::structfix($now, Struct::undef()))
                        !== json_encode(HongKongCsdiOmni::structfix($val, Struct::undef()))) {
